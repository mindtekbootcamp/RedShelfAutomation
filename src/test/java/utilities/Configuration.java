...
public class Configuration {
    ...
    static{
        String path = "/Users/yelizaveta/IdeaProjects/RedShelfAutomation/src/test/resources/configurations/Configuration.properties";
        try {
    ...
    public static String getProperty(String key){ // Configuration.getProperty("browser"); -> returns "chrome";
